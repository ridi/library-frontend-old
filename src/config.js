...
const { ACCOUNT_BASE_URL, LIBRARY_API_BASE_URL, PLATFORM_API_BASE_URL, ASSET_PREFIX } = publicRuntimeConfig;
const config = {
  ...
  ASSET_PREFIX: ASSET_PREFIX || 'https://library-static.ridibooks.com',
};
